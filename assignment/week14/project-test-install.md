...
Install another team's project on your computer according to
the instructions given in their project's README.md.  Try to run it.

Follow the instructions exactly and **open an issue** for any errors, 
missing steps, confusing or ambiguous instructions.
