...
[Separate configuration from code](refactoring/Separate-config-from-code.pdf) applies to all software, not just web apps.
</td>
</tr>
...
Managing dependencies and isolating apps in containers.
</td>
</tr>
</table>
...
Some of this may be *implicitly* covers as part of other topics.
...
<td markdown="span">
Uses retrospectives and on-going self-assessment to discover and *implement* improvements to
...
*Project notebook*, e.g. wiki, to record:
	...
	- important design decisions and *why* you made them (the rationale).  This helps all developers.
...
<td markdown="span">
Task board containing tasks for one iteration and their status    
Issue tracker for bugs, change requests, and more    
Burn-down or Burn-up chart (optional)    
Project wiki. A good location for iteration plans, software design notebook, recording knowledge and solutions    
**Information Radiators**:  these tools should quickly convey useful info & easily visible as part of your normal workflow
</td>
</tr>
<tr valign="top">
<td markdown="span">
...
<td markdown="span">
A frequent question from managers and customers is "*how long will it take?*" or "*when will be ready?*"  Planning requires good estimates, but most developers are very poor at estimation.
<br/>
